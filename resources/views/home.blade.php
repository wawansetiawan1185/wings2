		...
		<div class="col-md-12">
			...
			<div class="carousel-inner">
				<div class="item carousel-item active">
					<div class="row">
						@foreach($databarang as $j)
						<div class="col-sm-3">
							<div class="thumb-wrapper">
								<span class="wish-icon"><i class="fa fa-heart-o"></i></span>
								<div class="img-box">
									<img src="{{ URL::to('/') }}/sabun/{{ $j->gambar }}" height="10dp"class="img-fluid" alt="">									
								</div>
								<div class="thumb-content">
									...
									<?php $hasil= $j->price * $j->discount / 100;
									?>
									<p class="item-price">{{$j->discount}}%</p>
									<p class="item-price"><strike>{{$j->price}}</strike> <b>{{$hasil}}</b></p>
									<a href="{{url('/detail/'.$j->id)}}" class="btn btn-primary">Add to Cart</a>
								</div>						
							</div>
						</div>
						@endforeach
